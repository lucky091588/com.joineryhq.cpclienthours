 ...
 */
class CRM_Cpclienthours_Upgrader_Base {

  /**
   * @var CRM_Cpclienthours_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Cpclienthours_Upgrader(
   ...
   *
   * ```
   * CRM_Cpclienthours_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Cpclienthours_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
